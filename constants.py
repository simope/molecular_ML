# My periodic table in a dictionary
Z_TO_ELEMENT = {
    ...
    49: 'In', 50: 'Sn', 51: 'Sb', 52: 'I',  53: 'Te', 54: 'Xe', 55: 'Cs', 56: 'Ba',
...
# QM9 property names and their units
QM9_PROPS_UNITS = [
    ("dipole_moment", "Debye"),
    ("isotropic_polarizability", "Bohr^3"),
    ("homo_energy", "eV"),
    ("lumo_energy", "eV"),
    ("homo_lumo_gap", "eV"),
    ("electronic_spatial_extent", "Bohr^2"),
    ...
    ("atomization_energy_0K", "eV"),
    ("atomization_energy_298K", "eV"),
    ("atomization_enthalpy_298K", "eV"),
    ("atomization_free_energy_298K", "eV"),
